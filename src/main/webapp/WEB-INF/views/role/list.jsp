...
<!-- 选择权限弹窗 -->
<div id="select-authority-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'"
     style="width:220px;height:450px; padding:10px;">
...
<script type="text/javascript">
    ...
    function selectIcon() {
        if ($("#icons-table").children().length <= 0) {
            $.ajax({
                url: '${APP_PATH}/admin/role/get_icons',
                dataType: 'json',
                type: 'post',
                success: function (data) {
                    if (data.type == 'success') {
