...
<head>
    ...
    <title>SSM框架陳羽蒙在线考试后台管理员登录</title>
    <meta name="description" content="particles.js is a lightweight JavaScript library for creating particles.">
    <meta name="author" content="Vincent Garreau">
    <meta name="viewport"
          content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <link rel="stylesheet" media="screen" href="${APP_PATH}/resources/admin/login/css/style.css">
    <link rel="stylesheet" type="text/css" href="${APP_PATH}/resources/admin/login/css/reset.css">
<body>
...
<div id="particles-js">
    <div class="login" style="display: block;">
        ...
        <div class="login-center clearfix">
            <div class="login-center-img"><img src="${APP_PATH}/resources/admin/login/images/name.png"></div>
        ...
        <div class="login-center clearfix">
            <div class="login-center-img"><img src="${APP_PATH}/resources/admin/login/images/password.png"></div>
            <div class="login-center-input">
        ...
        <div class="login-center clearfix">
            <div class="login-center-img"><img src="${APP_PATH}/resources/admin/login/images/cpacha.png"></div>
            <div class="login-center-input">
...
<!-- scripts -->
<script src="${APP_PATH}/resources/admin/login/js/particles.min.js"></script>
<script src="${APP_PATH}/resources/admin/login/js/app.js"></script>
<script src="${APP_PATH}/resources/admin/login/js/jquery-1.8.0.min.js"></script>
