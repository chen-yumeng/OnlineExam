            ...
            <table width="100%" cellpadding="10" border="0" class="tm_table_list">
                ...
                <c:forEach items="${examList }" var="exam">
                    <tr id="tr-${exam.id }" data-key="${exam.id }">
                        <td>${exam.name }</td>
                        <td><fmt:formatDate value="${exam.startTime }" pattern="yyyy-MM-dd HH:mm:ss"/>---<fmt:formatDate
                                value="${exam.endTime }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
            ...
            <tr>
                <td>
                    <div class="tm_pager_foot">
                        <a <c:if test="${page}!=1">href="exam_list?page=${page - 1}"</c:if> class="tm_btns" style="color:white;text-decoration:none;">上一页</a>&nbsp;&nbsp;&nbsp;<font
                            size="5" color="red"><b>${page}</b></font>&nbsp;&nbsp;&nbsp;<a
                            <c:if test="${page}!=${totalPage}">href="exam_list?page=${page + 1}"</c:if> class="tm_btns"
