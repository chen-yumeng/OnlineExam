            ...
            <table width="100%" cellpadding="10" border="0" class="tm_table_list">
                ...
                <c:forEach items="${historyList }" var="history">
                    <tr>
                        ...
                        <td>
                            <a href="review_exam?examId=${history.exam.id }&examPaperId=${history.id}" target="_blank"
                               class="tm_btn tm_btn_primary" style="text-decoration:none;color:white;">回顾试卷</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
            ...
            <tr>
                <td>
                    <div class="tm_pager_foot">
                        <a <c:if test="${page}!=1">href="history_list?page=${page - 1}"</c:if> class="tm_btns"
                                style="color:white;text-decoration:none;">上一页</a>&nbsp;&nbsp;&nbsp;<font size="5" color="red"><b>${page}</b></font>&nbsp;&nbsp;&nbsp;<a
                            <c:if test="${page}!=${totalPage}">href="history_list?page=${page + 1}"</c:if>
                            class="tm_btns"
