    ...
    <form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
                    <select name="questionType" class="easyui-combobox easyui-validatebox" panelHeight="auto"
            ...
            <tr>
                ...
                <td><input type="text" id="add-attrA" name="attrA" class="wu-text easyui-validatebox"
                           data-options="required:true, missingMessage:'请填写选项A'"></td>
            </tr>
            <tr>
                <td align="right">试题选项B:</td>
                <td><input type="text" id="add-attrB" name="attrB" class="wu-text easyui-validatebox"
            ...
            <tr>
                ...
                <td><input type="text" id="add-answer" name="answer" class="wu-text easyui-validatebox"
    ...
    <form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td align="right">所属类型:</td>
                <td>
                    <select id="edit-questionType" name="questionType" class="easyui-combobox easyui-validatebox"
                            panelHeight="auto" style="width:268px"
            ...
            <tr>
                <td align="right">试题选项A:</td>
                <td><input type="text" id="edit-attrA" name="attrA" class="wu-text easyui-validatebox"
                           data-options="required:true, missingMessage:'请填写选项A'"></td>
            </tr>
            <tr>
                <td align="right">试题选项B:</td>
                <td><input type="text" id="edit-attrB" name="attrB" class="wu-text easyui-validatebox"
                           data-options="required:true, missingMessage:'请填写选项B'"></td>
            </tr>
            <tr>
                <td align="right">试题选项C:</td>
...
<div id="import-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'"
    ...
    <table>
        ...
        <tr>
            <td align="right">所属科目:</td>
            <td>
                <select id="import-subjectId" name="subjectId" class="easyui-combobox easyui-validatebox"
                        panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择考试科目'">
                    <c:forEach items="${subjectList}" var="subject">
                        <option value="${subject.id}">${subject.name}</option>
                    </c:forEach>
                </select>
        ...
        $.messager.confirm('信息提示', '确定要删除该记录？', function (result) {
            if (result) {
                ...
                $.ajax({
                    ...
                    data: JSON.stringify({questions:item,userId:${admin.id}}),
                    success: function (data) {
                        if (data.type == 'success') {
