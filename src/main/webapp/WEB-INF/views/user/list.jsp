        ...
        <table>
            <tr>
                ...
                <td valign="middle">
                    <img id="preview-photo" style="float:left;"
                         src="${APP_PATH}/resources/admin/easyui/images/user_photo.jpg" width="100px">
            ...
            <tr>
                ...
                <td><input type="text" id="add-photo" name="photo"
                           value="${APP_PATH}/resources/admin/easyui/images/user_photo.jpg" readonly="readonly"
                           class="wu-text "/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="age" class="wu-text easyui-numberbox easyui-validatebox"
    ...
    <form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td width="60" align="right">所属角色:</td>
                <td>
                    <select id="edit-roleId" name="roleId" class="easyui-combobox" panelHeight="auto"
                            style="width:268px" data-options="required:true, missingMessage:'请选择角色'">
                        <c:forEach items="${roleList }" var="role">
                            <option value="${role.id }">${role.name }</option>
                        </c:forEach>
                    </select>
